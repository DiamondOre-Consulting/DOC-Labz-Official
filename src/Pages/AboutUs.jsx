  ...
  return (
    <div>
      <section
        style={{
          backgroundImage:
            "url('https://img.freepik.com/free-photo/futuristic-business-office-space_23-2151003783.jpg?uid=R177576380&ga=GA1.1.119561090.1726138664&semt=ais_hybrid&w=740')",
        }}
          ...
          <div className="container px-4">
            <div className="grid grid-cols-12 gap-5 justify-center items-center">
              <div className="col-span-12 lg:col-span-6">
                <img
                  src="https://img.freepik.com/free-vector/two-developers-working-with-big-data-technology-illustration_335657-349.jpg?t=st=1745918743~exp=1745922343~hmac=2c2cecae0ac5561fa56993015736026b1ce2f8546d2d8470a2de09f1e7df2a37&w=826"
                  className=""
                  alt=""
                />
              ...
              <div className="col-span-12 lg:col-span-6">
                <div className="lg:ml-12">
                  <p className="opacity-75 mb-4">
                    <span className="text-[40px] text-color1 font-bold">D</span>
                    oc-Labz is where cutting-edge innovation meets exceptional
                    execution. Our expert team of tech-savvy professionals is
                    driven by a passion for solving complex challenges and
                    delivering real business value through transformative IT
                    consulting solutions.
                  </p>
                  <p className="opacity-75 mb-4">
                    We specialize in user-centric strategies that redefine how
                    digital services are delivered. From intelligent automation
                    to scalable cloud infrastructures, our solutions are
                    tailored to streamline operations, enhance performance, and
                    accelerate growth.
                  </p>
                  <p className="opacity-75">
                    At Doc-Labz, we don’t just build systems — we craft
                    experiences. Our commitment to excellence ensures that every
                    project is executed with precision, transparency, and a
                    relentless focus on customer satisfaction. Partner with us
                    to drive your business forward through innovation.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="col-span-12 md:col-span-6">
                <div className="flex flex-col justify-center h-full">
                  ...
                  <p className="text-[17px] opacity-80">
                    ...
                    drive success across a wide range of industries. By
                    fostering strong client relationships and leading innovative
                    projects, we aim to create exceptional value for every
                    partner we serve.
                  </p>
                  <Cards />
                  ...
                  <Link
                    to={"/contact-us"}
                    className="py-3 px-9 w-fit rounded bg-color1 text-white hover:bg-opacity-90 duration-300"
                  >
                    Contact us
                  </Link>
                </div>
