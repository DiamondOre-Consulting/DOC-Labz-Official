...
const ContactusPage = () => {
  ...
  return (
    <>
      <section class="bg-gray-50" id="contactus">
        <div class=" px-6 md:px-12 py-10 ">
          <h1 className="text-3xl py-2 px-4 font-semibold">Contact Us</h1>
          <div class="py-4">
            <div class="flex flex-wrap">
              ...
              <div class=" mt-12 lg:-mt-10 w-full bg-white py-6 shrink-0 grow-0 basis-auto  px-4 md:px-7 lg:mb-0 lg:w-5/12 lg:px-6">
              <h1 className="text-xl mb-4 font-semibold text-gray-800">Send Us a Message</h1>
                <form onSubmit={handleSubmit}>
                  <div
                    className={`relative mb-6 ${formData.name ? "active" : ""}`}
                  ...
                  >
                    ...
                    />
                    <label
                      className={`absolute top-0 left-3 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out ${
                        formData.name
        ...
        >
          <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d56039.41861215709!2d77.3733795!3d28.6158626!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cef068957c2f1%3A0xe72309664887757f!2sDiamond%20Ore%20Consulting%20Pvt.%20Ltd.!5e0!3m2!1sen!2sin!4v1706784809360!5m2!1sen!2sin"
            height="450"
            allowFullScreen=""
            loading="lazy"
