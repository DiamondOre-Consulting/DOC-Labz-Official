            ...
            <div class="h-full  w-full mt-24  pt-12 p-4">
                ...
                <div class="grid gap-14 md:grid-cols-4 md:gap-5 px-10">
                    ...
                    <div className={`rounded-xl  p-6 text-center shadow-xl ${inView ? 'animate__animated animate__backInUp' : ''}`} ref={ref}>
                        ...
                        <p class="px-4 text-gray-500">DocLabs prioritizes delivering your projects on time, every time. Count on us to meet your deadlines with precision and reliability, ensuring your satisfaction and success.</p>
                    </div>
