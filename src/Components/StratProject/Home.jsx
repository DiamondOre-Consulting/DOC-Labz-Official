...
const Home = () => {
  ...
  useEffect(() => {
    ...
    typewriter
      ...
      .typeString(
        '<span class="relative whitespace-nowrap text-green-400"><span class="relative"> Work </span></span>'
      )
      ...
      <div className="grid grid-cols-2 md:grid-cols-6 px-10 justify-center justify-items-center content-center">
        <div class="mx-auto col-span-4   sm:px-6 lg:px-8  pb-16 text-center pt-20  lg:pt-32">
          ...
          <div class="mt-12 flex flex-col justify-center gap-y-5 sm:mt-10 sm:flex-row sm:gap-y-0 sm:gap-x-6">
            <a
              class="group inline-flex items-center justify-center rounded-full py-2 px-14 text-sm font-semibold focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 bg-slate-900 text-white hover:bg-slate-700 hover:text-slate-100 active:bg-slate-800 active:text-slate-300 focus-visible:outline-slate-900 animate-fade-in-left"
              href="#"
          ...
          <p class="mx-auto max-w-3xl text-lg tracking-tight text-slate-700 mt-10 cursor-pointer">
            ...
            <a
              ...
              className="inline-block mt-4 cursor-pointer hover:underline"
            >
              tech@doclabz.com
            </a>
          </p>
        ...
        <div className="col-span-2 w-full mt-10">
          <form
            class="max-w-md mx-auto  p-6 bg-gradient-to-r from-emerald-200 to-lime-300 border rounded-lg shadow-lg"
            onSubmit={handleSubmit}
          >
            <h2 class="text-2xl  mb-6">Contact us</h2>
            <div class="mb-4">
              <input
                class="shadow appearance-none bg-gray-50 border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                id="name"
                type="text"
            ...
            <div class="mb-4">
              <input
                class="shadow appearance-none border bg-gray-50 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                id="email"
                type="email"
            ...
            <button
              class="bg-gray-50 rounded-md  py-2 px-4 rounded focus:outline-none focus:shadow-outline"
              type="submit"
            >
              {showLoader ? (
                <svg
