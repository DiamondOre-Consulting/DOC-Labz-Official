    ...
    return (
        <div className='px-10 'id="about">
            ...
            <div className='px-0 md:px-20 mt-10'>
                <p>
                    Doc-Labz is a premier IT consulting firm dedicated to providing exceptional services in web development, UI/UX design, and digital marketing.
                </p>
                <p>
                ...
                <p>
                    At Doc-Labz, we believe in the power of technology to transform businesses and drive growth. Whether you're looking to create a stunning website, optimize user experience, or boost your online presence, we've got you covered.
                </p>
                <p>
