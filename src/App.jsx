  ...
  return (
    <>
      ...
      <Routes>
        <Route setLanguage={setLanguage} language={language} path="/">
          ...
          <Route
            path="/start/project"
            element={
              <StartProjects language={language} setLanguage={setLanguage} />
            }
          />
      ...
      <div
        ...
        className=" cursor-pointer fixed bottom-10 right-10 bg-white rounded-full shadow-xl p-6 text-gray-700 animate-bounce"
      >
        <FaArrowDown />
      </div>
    </>
